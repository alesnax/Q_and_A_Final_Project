...
public class UploadFileCommand implements Command {
    ...
    private static final String UNDER_DELIMITR = "_";
    ...
    private static final int MAX_FILE_SIZE = 800 * 1024;// change to path
                ...
                if (item.isFormField()) {
                    ...
                    if (commandDefined && command.equals("upload_avatar")) {
                        ...
                        if (fileName.lastIndexOf(DOT_DELIMITER) >= 0) {
                            shortFilePath = avatarPatternName + user.getId() + UNDER_DELIMITR + new Date().getTime() + fileName.substring(fileName.lastIndexOf(DOT_DELIMITER));
