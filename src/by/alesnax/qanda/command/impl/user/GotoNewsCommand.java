...
/**
 * Command has method that takes list of posts of followers from service layer ,
...
public class GotoNewsCommand implements Command {
    ...
    /**
     * Process redirecting to news.jsp and putting attribute into session which contains posts list,
     ...
     * @return value of news page if success scenario or error or authorization page otherwise)
     */
    @Override
