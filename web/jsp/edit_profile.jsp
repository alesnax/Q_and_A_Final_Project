                ...
                <div class="top_block">
                    ...
                    <div class="page_block upload_avatar_block">
                        ...
                        <form enctype="multipart/form-data" class="load_avatar_form"
                            ...
                            <div class="form_element submit_button">
                                <fmt:message bundle="${loc}" key="edit_profile.user_data_form.submit_button"
                                             var="submit_v"/>
                                <input type="submit" value="${submit_v}" name="submit" class="reg_button_load">
                            </div>
                        </form>
                    ...
                    <div class="page_block change_lang_block">
                        ...
                        <form class="change_lang_form" name="change_language" action="/Controller" method="post">
                            ...
                            <div class="form_element submit_button">
                                <fmt:message bundle="${loc}" key="edit_profile.change_lang.submit_button"
                                             var="submit_change"/>
                                <input type="submit" value="${submit_change}" name="submit" class="reg_button_load">
                            </div>
                        </form>
                ...
                <div class="create_account_form_block page_block">
                    <form onsubmit="return validateForm('${sessionScope.locale}')" class="create_account_form"
                        ...
                        <div class="form_element name">
                            <label>
                                <div class="left_form_text">
                                    <fmt:message bundle="${loc}" key="user_registration.form.first_name.placeholder"
                                                 var="fname_ph"/>
                                    <strong>
                                ...
                                <div class="right_form_field">
                                    <input type="text" value="${sessionScope.user.name}" name="FirstName" id="FirstName"
                                           class="" placeholder="${fname_ph}">
                        ...
                        <div class="form_element name">
                            <label>
                                <div class="left_form_text">
                                    <fmt:message bundle="${loc}" key="user_registration.form.last_name.placeholder"
                                                 var="lname_ph"/>
                                    <strong>
                                ...
                                <div class="right_form_field">
                                    <input type="text" value="${sessionScope.user.surname}" name="LastName"
                                           id="LastName" class="" placeholder="${lname_ph}">
                        ...
                        <div class="form_element login">
                            <label>
                                <fmt:message bundle="${loc}" key="user_registration.form.login.placeholder"
                                             var="login_ph"/>
                                <div class="left_form_text">
                                    <strong>
                                ...
                                <div class="right_form_field">
                                    <input type="text" value="${sessionScope.user.login}" name="login" id="login"
                                           class="" placeholder="${login_ph}">
                        ...
                        <div class="form_element email">
                            <label>
                                ...
                                <div class="right_form_field">
                                    <input type="text" value="${sessionScope.user.email}" name="email" id="email"
                                           class="" placeholder="${email_ph}">
                                ...
                                <div class="right_form_field">
                                    <fieldset>
                                                    ...
                                                    <c:when test="${(sessionScope.user.birthday.month + 1) eq m_numb}">
                                                        <option selected="selected" value="${m_numb}">
                                                            <fmt:message bundle="${loc}"
                                                                         key="user_registration.form.birthday.month.value${m_numb}"/>
                                                        </option>
                                                    </c:when>
                                                    <c:otherwise>
                                                        <option value="${m_numb}">
                                        ...
                                        <select class="birth_year" name="birth_year">
                                            <fmt:message bundle="${config}" key="user_registration_page.year_low_limit"
                                                         var="min_year"/>
                                            <fmt:message bundle="${config}" key="user_registration_page.year_top_limit"
                                                         var="max_year"/>
                                        ...
                                        <c:choose>
                                            <c:when test="${sessionScope.user.sex}">
                                                <option selected="selected" value="1">
                                                    <fmt:message bundle="${loc}"
                                                                 key="user_registration.form.gender.male"/>
                                                </option>
                                                <option value="2">
                                                    <fmt:message bundle="${loc}"
                                                                 key="user_registration.form.gender.female"/>
                                                </option>
                                            </c:when>
                                            <c:otherwise>
                                                <option value="1">
                        ...
                        <div class="form_element country">
                            <label>
                                <div class="left_form_text">
                                    <fmt:message bundle="${loc}" key="user_registration.form.country.placeholder"
                                                 var="country_ph"/>
                                    <strong>
                                ...
                                <div class="right_form_field">
                                    <input type="text" value="${sessionScope.user.country}" name="country" id="country"
                                           class="" placeholder="${country_ph}">
                        ...
                        <div class="form_element city">
                            <label>
                                <div class="left_form_text">
                                    <fmt:message bundle="${loc}" key="user_registration.form.city.placeholder"
                                                 var="city_ph"/>
                                    <strong>
                                ...
                                <div class="right_form_field">
                                    <input type="text" value="${sessionScope.user.city}" name="city" id="city" class=""
                                           placeholder="${city_ph}">
                        ...
                        <div class="form_element page_status">
                            <label>
                                <div class="left_form_text">
                                    <fmt:message bundle="${loc}" key="user_registration.form.status.placeholder"
                                                 var="status_ph"/>
                                    <strong>
                                ...
                                <div class="right_form_field">
                                    <input type="text" value="${sessionScope.user.status}" name="page_status"
                                           id="page_status" class="" placeholder="${status_ph}">
                                </div>
                            </label>
                        </div>
                        <div class="form_element ">
                    ...
                    <form onsubmit="return validatePasswords('${sessionScope.locale}')" class="create_account_form"
                        ...
                        <div class="form_element password_form_element">
                            <label>
                                <div class="left_form_text">
                                    <fmt:message bundle="${loc}"
                                                 key="edit_profile.change_password_form.pass1.placeholder"
                                                 var="p1_ph"/>
                                    <strong>
                                ...
                                <div class="right_form_field">
                                    <input type="password" value name="OldPasswd" id="OldPasswd" class=""
                                           placeholder="${p1_ph}">
                        ...
                        <div class="form_element password_form_element">
                            <label>
                                <div class="left_form_text">
                                    <fmt:message bundle="${loc}"
                                                 key="edit_profile.change_password_form.pass2.placeholder"
                                                 var="p2_ph"/>
                                    <strong>
                        ...
                        <div class="form_element password_form_element">
                            <label>
                                <fmt:message bundle="${loc}" key="edit_profile.change_password_form.pass3.placeholder"
                                             var="p3_ph"/>
                                <div class="left_form_text">
                                ...
                                <div class="right_form_field">
                                    <input type="password" value name="PasswdAgain" id="PasswdAgain" class=""
                                           placeholder="${p3_ph}">
                        ...
                        <div class="form_element submit_button">
                            <fmt:message bundle="${loc}" key="edit_profile.change_password_form.submit_button"
                                         var="submit_val"/>
...
<fmt:message bundle="${config}" key="path.js.edit_user_data_validation_script" var="valid_script"/>
