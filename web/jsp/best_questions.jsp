...
<head>
    <meta charset="utf-8">
    <title>
        <fmt:message bundle="${loc}" key="best_q.page_title"/>
    </title>
                ...
                <ul class="pagination">
                    ...
                    <c:forEach var="number" begin="1" end="${requestScope.posts.getTotalPagesCount()}">
                        <c:choose>
                            ...
                            <c:otherwise>
                                <li>
                                    <a href="${find_best_questions}${page_no}${number}">${number}</a>
                                </li>
                            </c:otherwise>
                        </c:choose>
                    </c:forEach>
